...
const _eventBus = new EventBus<PassageShown, PassageShownEvent, Window>(PASSAGE_SHOWN, window);
...
export const onPassageShown = _eventBus.addListener.bind(_eventBus);
